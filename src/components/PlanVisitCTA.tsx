...
export default function PlanVisitCTA() {
  return (
    <section id="plan" className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 sm:-mt-10 mb-16">
      <div className="relative rounded-3xl overflow-hidden shadow-card border border-slate-200/80 min-h-[260px] sm:min-h-[300px] flex items-center group">
        ...
        <div className="relative z-10 w-full p-6 sm:p-10 md:p-12 flex items-center justify-end">
          ...
          {/* Text & Button Content Box (Pushed to the Right End with ml-auto) */}
          <div className="w-full md:w-1/2 lg:w-5/12 ml-auto flex flex-col items-start space-y-4 text-left">
            <h2 className="font-heading font-extrabold text-2xl sm:text-3xl lg:text-4xl text-primary tracking-tight leading-tight">
              Plan Your Visit to Tiruvannamalai
            </h2>
            
            <p className="text-text-gray text-sm sm:text-base font-medium leading-relaxed">
            ...
            <div className="pt-2">
              <Link
                href="#travel-guide"
                className="inline-flex items-center gap-2 bg-accent-orange hover:bg-accent-orange/90 text-white font-heading font-semibold text-sm sm:text-base px-7 py-3.5 rounded-full shadow-md shadow-accent-orange/25 hover:shadow-lg transition-all transform hover:-translate-y-0.5 active:translate-y-0"
              >
